  ...
  return (
    <div>
      ...
      <div className="about">
        ...
        <Icon type={faBookOpenReader} size="5x" title="Reader" body="I have recently refound my love for reading. My favorite genres/books include manga (Blue Period and Oshi no Ko), novels (China Rich Girlfriend), and self-help books (The War of Art by Steven Pressfield)."></Icon>
      </div>
